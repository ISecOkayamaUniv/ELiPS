...
void efp2_ecd_jacobian(efp2_jacobian_t *ANS,efp2_jacobian_t *P){
    static efp2_jacobian_t Pt;
    static fp2_t tmp1_fp2,tmp2_fp2,tmp3_fp2;
    static fp2_t tmpy_fp2;
    static fp2_t s,m,T;
    if(fp2_cmp_zero(&P->y)==0){
        ANS->infinity=1;
        return;
...
void efp2_ecd_lazy(efp2_t *ANS,efp2_t *P){
    static efp2_t tmp1_efp2;
    static fp2_t tmp1_fp2,tmp2_fp2,tmp3_fp2;
    if(fp2_cmp_zero(&P->y)==0){
        ANS->infinity=1;
...
void efp2_ecd_jacobian_lazy(efp2_jacobian_t *ANS,efp2_jacobian_t *P){
    static efp2_jacobian_t Pt;
    static fp2_t tmp1_fp2,tmp2_fp2,tmp3_fp2;
    static fp2_t tmpy_fp2;
    static fp2_t s,m,T;
...
void efp2_eca_jacobian(efp2_jacobian_t *ANS,efp2_jacobian_t *P1,efp2_jacobian_t *P2){
    static efp2_jacobian_t Pt1,Pt2;
    static fp2_t tmp1_fp2,tmp2_fp2,tmp3_fp2;
    static fp2_t tmpZ1_fp2,tmpZ2_fp2,tmpH2_fp2,tmpH3_fp2,tmpU1H2_fp2;
...
void efp2_eca_jacobian_scm(efp2_jacobian_t *ANS,efp2_jacobian_t *P1,efp2_jacobian_t *P2){
    static efp2_jacobian_t Pt1,Pt2;
    static fp2_t tmp1_fp2,tmp2_fp2,tmp3_fp2;
    static fp2_t tmpZ1_fp2,tmpZ2_fp2,tmpH2_fp2,tmpH3_fp2,tmpU1H2_fp2;
    static fp2_t U1,U2,S1,S2,H,r;
...
void efp2_eca_lazy(efp2_t *ANS,efp2_t *P1,efp2_t *P2){
    static efp2_t tmp1_efp2,tmp2_efp2;
    static fp2_t tmp1_fp2,tmp2_fp2,tmp3_fp2;
    if(P1->infinity==1){
        efp2_set(ANS,P2);
...
void efp2_eca_jacobian_lazy(efp2_jacobian_t *ANS,efp2_jacobian_t *P1,efp2_jacobian_t *P2){
    static efp2_jacobian_t Pt1,Pt2;
    static fp2_t tmp1_fp2,tmp2_fp2,tmp3_fp2;
    static fp2_t tmpZ1_fp2,tmpZ2_fp2,tmpH2_fp2,tmpH3_fp2,tmpU1H2_fp2;
    static fp2_t U1,U2,S1,S2,H,r;
...
void efp2_eca_mixture_lazy(efp2_jacobian_t *ANS,efp2_jacobian_t *P1,efp2_jacobian_t *P2){
    static efp2_jacobian_t Pt1,Pt2;
...
void efp2_eca_jacobian_scm_lazy(efp2_jacobian_t *ANS,efp2_jacobian_t *P1,efp2_jacobian_t *P2){
    static efp2_jacobian_t Pt1,Pt2;
    static fp2_t tmp1_fp2,tmp2_fp2,tmp3_fp2;
    static fp2_t tmpZ1_fp2,tmpZ2_fp2,tmpH2_fp2,tmpH3_fp2,tmpU1H2_fp2;
    static fp2_t U1,U2,S1,S2,H,r;
...
void efp2_scm_jacobian(efp2_t *ANS,efp2_t *P,mpz_t scalar){
    if(mpz_cmp_ui(scalar,0)==0){
        ANS->infinity=1;
        return;
    }else if(mpz_cmp_ui(scalar,1)==0){
    ...
    efp2_jacobian_t Tmp_P,Next_P;
    efp2_affine_to_jacobian(&Tmp_P,P);
    ...
    efp2_jacobian_set(&Next_P,&Tmp_P);
    for(i=1;i<length; i++){
    ...
    efp2_jacobian_to_affine(ANS,&Next_P);
}
void efp2_scm_lazy(efp2_t *ANS,efp2_t *P,mpz_t scalar){
    if(mpz_cmp_ui(scalar,0)==0){
        ANS->infinity=1;
        return;
    }else if(mpz_cmp_ui(scalar,1)==0){
...
void efp2_scm_jacobian_lazy(efp2_t *ANS,efp2_t *P,mpz_t scalar){
    if(mpz_cmp_ui(scalar,0)==0){
        ANS->infinity=1;
        return;
    }else if(mpz_cmp_ui(scalar,1)==0){
