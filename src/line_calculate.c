...
void fp6_6_sparse_mul_lazy_montgomery(fpd6_t *C, fp6_t *A, fp6_t *B){
    ...
    fp2_mul_basis_lazy_double(&tmp3_fpd2, &tmp2_fpd2);
...
void ff_ltt_projective_lazy(fp12_t *f,efp2_projective_t *T,efp_t *P){
	...
	fp_div2(&tmp4_fp2.x0, &tmp4_fp2.x0);
	fp_div2(&tmp4_fp2.x1, &tmp4_fp2.x1);
	...
	fp_div2(&tmp3_fp2.x0, &tmp3_fp2.x0);
	fp_div2(&tmp3_fp2.x1, &tmp3_fp2.x1);
