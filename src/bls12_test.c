...
void BLS12_test_x_ate_pairing(){
    ...
    BLS12_X_ate_pairing(&test2,&s1P,&s2Q);
    printf("Miller's Algo. (X-ate) : %.2f[ms]\n",MILLER_XATE);
    printf("Final Exp. (easy)  : %.2f[ms]\n",FINALEXP_OPT_EASY);
    printf("Final Exp. (hard)  : %.2f[ms]\n",FINALEXP_OPT_HARD);
    printf("Final Exp. (total) : %.2f[ms]\n",MILLER_XATE+FINALEXP_OPT_EASY+FINALEXP_OPT_HARD);
    ...
    BLS12_X_ate_pairing(&test3,&s2P,&s1Q);
    printf("Miller's Algo. (X-ate) : %.2f[ms]\n",MILLER_XATE);
    printf("Final Exp. (easy)  : %.2f[ms]\n",FINALEXP_OPT_EASY);
    printf("Final Exp. (hard)  : %.2f[ms]\n",FINALEXP_OPT_HARD);
    printf("Final Exp. (total) : %.2f[ms]\n",MILLER_XATE+FINALEXP_OPT_EASY+FINALEXP_OPT_HARD);
...
int BLS12_test_G1_SCM(){
    ...
    printf("test2\n\n");
    printf("2split\n");
    BLS12_EFp12_G1_SCM_2split(&test2,&P,scalar);
    ...
    printf("test3\n\n");
    printf("2split-JSF\n");
    BLS12_EFp12_G1_SCM_2split_JSF(&test3,&P,scalar);
...
int BLS12_test_G2_SCM(){
    ...
    printf("test4\n\n");
    printf("4split\n");
    BLS12_EFp12_G2_SCM_4split(&test4,&Q,scalar);
...
int BLS12_test_G3_EXP(){
    ...
    mpz_set_str(scalar,"521481209941628438105040837477752229019680713610788130306766813411699047520874395885887221",10);
    printf("scalar : %d-bit\n",(int)mpz_sizeinbase(scalar,2));
    ...
    printf("test4\n\n");
    printf("4split\n");
    BLS12_Fp12_G3_EXP_4split(&test4,&Z,scalar);
