...
void BLS12_Fp12_pow_X_compress_lazy_montgomery(Fp12 *ANS,Fp12 *A){
    int i;
    Fp12 tmp,A_inv;
    Fp12 tmp6,tmp9,tmp11,tmp77;
...
void BLS12_Fp12_pow_X2_compress_lazy_montgomery(Fp12 *ANS,Fp12 *A){
    int i;
    Fp12 tmp,A_inv;
    Fp12 tmp5,tmp8,tmp10,tmp76;
...
void BLS12_Final_exp_optimal_compress_lazy_montgomery(Fp12 *ANS,Fp12 *A){
    Fp12 tmp,t0,t1,t2,t3,t4,t5, test,At;
    Fp12_init(&tmp);
    Fp12_init(&t0);
    Fp12_init(&t1);
    Fp12_init(&t2);
