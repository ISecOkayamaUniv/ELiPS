...
//     mpz_tdiv_qr(s[1],s[0],A,X_mod_order_z);
//     mpz_tdiv_qr(s[3],s[2],B,X_mod_order_z);
...
void test_g2_scm_w_naf(efp12_t *ANS,efp12_t *Q,mpz_t scalar,int w){
    ...
    mpz_tdiv_qr(B,A,scalar,x_2);
    mpz_tdiv_qr(s[1],s[0],A,X_abs_z);
    mpz_tdiv_qr(s[3],s[2],B,X_abs_z);
...
void test_g2_scm_jsf(efp12_t *ANS,efp12_t *Q,mpz_t scalar){
    ...
    //s0,s1
    mpz_tdiv_qr(s[1],s[0],scalar,X_mod_order_z);
