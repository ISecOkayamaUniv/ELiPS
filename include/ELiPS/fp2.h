 ...
 * @param[in]UI --an unsigned long int to shift.
 */
extern void fp2_l1shift(fp2_t *ANS, fp2_t *A);
extern void fp2_r1shift(fp2_t *ANS, fp2_t *A);
...
/**
 * @brief Multiplication a fp2_t type struct and an unsigned long int
 *
 * @param[out]ANS --a pointer of answer.
 * @param[in]A --a pointer in fp2_t.
 * @param[in]B --an unsigned long int.
 */
extern void fp2_mul_ui_nonmod_single(fp2_t *ANS, fp2_t *A, unsigned long int UI);
 ...
 * @param[in]A --a pointer in fp2_t.
 */
extern void fp2_mul_basis_nonmod_single(fp2_t *ANS, fp2_t *A);
extern void fp2_mul_basis_nonmod_double(fpd2_t *ANS, fpd2_t *A);
...
extern void fp2_mul_3_twist_b(fp2_t *ANS, fp2_t *A);
extern void fp2_lshift_ui_nonmod_single(fp2_t *ANS, fp2_t *A, int s);
extern void fp2_lshift_ui_nonmod_double(fpd2_t *ANS, fpd2_t *A, int s);
#endif
