...
extern void fpm_set_fp2cv(fpm_t *a, fp2cv_t *b);
extern void fpm_set_fpm(fpm_t *a, fpm_t *b);
...
extern void fpm_mul_ui(fpm_t *c, fpm_t *a, unsigned long int b);
extern void fpm_mul_fp(fpm_t *c, fpm_t *a, fp_t *b);
//sqr
...
extern int fpm_legendre3(fpm_t *a);
