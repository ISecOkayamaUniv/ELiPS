...
extern void mpz_set_mpn_size(mpz_t ans, mp_limb_t *a, int bits, mp_size_t size);
...
extern void g1_map_from_efp(g1_t *ANS, efp_t *P);
...
extern void g2_map_from_efp2(g2_t *ANS, efp2_t *A);
